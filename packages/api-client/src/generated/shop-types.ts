...
export type RemoveOrderLineMutation = {
  ...
  removeOrderLine:
    | {
        ...
        code: string;
        total: number;
        lines: Array<{ __typename?: "OrderLine"; id: string }>;
      }
    | {
        __typename?: "OrderInterceptorError";
        errorCode: ErrorCode;
...
`;
export type UpdateOrderLineMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useUpdateOrderLineMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateOrderLineMutation,
    UpdateOrderLineMutationVariables
  >,
  ...
  return Apollo.useMutation<
    UpdateOrderLineMutation,
    UpdateOrderLineMutationVariables
  >(UpdateOrderLineDocument, options);
}
export type UpdateOrderLineMutationHookResult = ReturnType<
  typeof useUpdateOrderLineMutation
>;
export type UpdateOrderLineMutationResult =
  Apollo.MutationResult<UpdateOrderLineMutation>;
