...
export const GetAdminProductsDocument = gql`
  query GetAdminProducts($options: ProductListOptions) {
...
export function useGetAdminProductsLazyQuery(
  ...
  return Apollo.useLazyQuery<
    GetAdminProductsQuery,
    GetAdminProductsQueryVariables
  >(GetAdminProductsDocument, options);
}
export function useGetAdminProductsSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetAdminProductsQuery,
...
export type GetAdminProductsQueryHookResult = ReturnType<
  typeof useGetAdminProductsQuery
>;
export type GetAdminProductsLazyQueryHookResult = ReturnType<
  typeof useGetAdminProductsLazyQuery
>;
export type GetAdminProductsSuspenseQueryHookResult = ReturnType<
  typeof useGetAdminProductsSuspenseQuery
>;
...
`;
export type CreateProductVariantsMutationFn = Apollo.MutationFunction<
 ...
 *
 * To run a mutation, you first call `useCreateProductVariantsMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateProductVariantsMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [createProductVariantsMutation, { data, loading, error }] = useCreateProductVariantsMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
...
export function useCreateProductVariantsMutation(
  ...
  return Apollo.useMutation<
    CreateProductVariantsMutation,
    CreateProductVariantsMutationVariables
  >(CreateProductVariantsDocument, options);
}
export type CreateProductVariantsMutationHookResult = ReturnType<
  typeof useCreateProductVariantsMutation
>;
export type CreateProductVariantsMutationResult =
  Apollo.MutationResult<CreateProductVariantsMutation>;
export type CreateProductVariantsMutationOptions = Apollo.BaseMutationOptions<
  CreateProductVariantsMutation,
  CreateProductVariantsMutationVariables
>;
...
`;
export type UpdateProductVariantsMutationFn = Apollo.MutationFunction<
  UpdateProductVariantsMutation,
  UpdateProductVariantsMutationVariables
>;

/**
 * __useUpdateProductVariantsMutation__
 *
 * To run a mutation, you first call `useUpdateProductVariantsMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateProductVariantsMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateProductVariantsMutation, { data, loading, error }] = useUpdateProductVariantsMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
...
export function useUpdateProductVariantsMutation(
  ...
  return Apollo.useMutation<
    UpdateProductVariantsMutation,
    UpdateProductVariantsMutationVariables
  >(UpdateProductVariantsDocument, options);
}
export type UpdateProductVariantsMutationHookResult = ReturnType<
  typeof useUpdateProductVariantsMutation
>;
export type UpdateProductVariantsMutationResult =
  Apollo.MutationResult<UpdateProductVariantsMutation>;
export type UpdateProductVariantsMutationOptions = Apollo.BaseMutationOptions<
  UpdateProductVariantsMutation,
  UpdateProductVariantsMutationVariables
>;
