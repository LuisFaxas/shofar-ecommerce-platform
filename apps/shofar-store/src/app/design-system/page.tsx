...
import { HorizontalSnapCarousel } from "@/brands/tooly/components/ui/HorizontalSnapCarousel";
...
// Sample trust badges for carousel demo
const sampleTrustBadges = [
  ...
  return (
    <PointerVarsProvider>
      ...
      <div className="min-h-screen relative z-10">
        ...
        {/* Horizontal Snap Carousel Section */}
        <Section
          title="Horizontal Snap Carousel"
          subtitle="Mobile scroll-snap carousel that transforms to grid on desktop"
          containerSize="lg"
          spacing="lg"
        >
          <div className="space-y-12">
            ...
            <Card glass padding="lg">
              <CardHeader bordered>
                ...
                <p className="text-white/60 text-sm mt-2">
                  Used in CredibilitySection. Horizontal scroll with snap on
                  mobile, 4-column grid on desktop.
                </p>
              </CardHeader>
              <CardBody>
                <HorizontalSnapCarousel
                  ...
                  desktopColumns={4}
                  gap="md"
                  ariaLabel="Trust badges demo"
                >
                  {sampleTrustBadges.map((badge, index) => (
                    <div
                      key={index}
                      className="flex items-center gap-3 p-4 rounded-lg h-full bg-white/[0.02] border border-white/[0.06]"
                    >
                ...
                <p className="text-center text-white/40 text-sm mt-4">
                  Resize browser to see mobile/desktop behavior
                </p>
              </CardBody>
            </Card>
            ...
            <Card glass padding="lg">
              <CardHeader bordered>
                ...
                <p className="text-white/60 text-sm mt-2">
                  Reusable for any card content. 3-column grid on desktop.
                </p>
              </CardHeader>
              <CardBody>
                <HorizontalSnapCarousel
                  ...
                  {[
                    ...
                    >
                      <div className="aspect-square bg-gradient-to-br from-white/10 to-white/5 relative">
                        <span className="absolute top-3 left-3 px-2 py-1 rounded bg-gradient-to-r from-[#02fcef] to-[#a02bfe] text-[10px] font-bold text-white">
                          {product.badge}
                        </span>
                      </div>
                      <div className="p-4">
              ...
              <CardBody>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <h4 className="text-white/80 font-medium">Props</h4>
                    <ul className="text-sm text-white/60 space-y-1">
                      <li>
                        <code className="text-white/80">itemWidth</code>: Mobile
                        item width (px)
                      </li>
                      <li>
                        <code className="text-white/80">desktopColumns</code>:
                        Grid cols (2-6)
                      </li>
                      <li>
                        <code className="text-white/80">gap</code>: sm | md | lg
                      </li>
                      <li>
                        <code className="text-white/80">snapAlign</code>: start
                        | center
                      </li>
                    </ul>
                  </div>
                  <div className="space-y-2">
                    <h4 className="text-white/80 font-medium">Features</h4>
                    <ul className="text-sm text-white/60 space-y-1">
                      <li>Native scroll-snap on mobile</li>
                      <li>CSS grid on desktop (768px+)</li>
                      <li>No JS scroll handling needed</li>
                      <li>ARIA region for accessibility</li>
                    </ul>
                  </div>
                </div>
              </CardBody>
