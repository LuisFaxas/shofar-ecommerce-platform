...
export const metadata: Metadata = {
  ...
  description:
    "Shipping information for PEPTIDES - delivery times, methods, and policies.",
};
      ...
      <Section title="Shipping Policy">
        <div className="prose prose-gray max-w-none">
          <p className="text-body text-[var(--peptide-fg-muted)]">
            This page is under construction. Our full shipping policy will be
            available soon.
          </p>
            ...
            <table className="w-full text-body-sm">
              <tbody>
                <tr className="border-b border-[var(--peptide-border)]">
                  <td className="py-2 text-[var(--peptide-fg)]">
                    Standard Shipping
                  </td>
                  <td className="py-2 text-[var(--peptide-fg-muted)]">
                    5-7 business days
                  </td>
                </tr>
                <tr className="border-b border-[var(--peptide-border)]">
