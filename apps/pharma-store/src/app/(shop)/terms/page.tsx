...
export const metadata: Metadata = {
  ...
  description:
    "Terms and conditions for using PEPTIDES services and purchasing products.",
};
      ...
      <Section title="Terms of Service">
        <div className="prose prose-gray max-w-none">
          <p className="text-body text-[var(--peptide-fg-muted)]">
            This page is under construction. Our full terms of service will be
            available soon.
          </p>
          ...
          <div className="mt-8">
            <ResearchDisclaimer variant="card">
              By purchasing from PEPTIDES, you acknowledge that all products are
              intended for laboratory research purposes only and are not for
              human consumption.
            </ResearchDisclaimer>
          </div>
          ...
          <div className="mt-8 p-6 border border-[var(--peptide-border)] rounded-lg">
            <h3 className="text-h4 text-[var(--peptide-fg)] mb-4">
              Acceptable Use
            </h3>
            <p className="text-body-sm text-[var(--peptide-fg-muted)]">
              ...
              By purchasing our products, you agree to use them only for lawful
              research purposes in accordance with all applicable laws and
              regulations.
            </p>
          </div>
